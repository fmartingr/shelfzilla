...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Series.status'
        db.add_column(u'manga_series', 'status',
                      self.gf('django.db.models.fields.CharField')(default='open', max_length=16),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Series.status'
        db.delete_column(u'manga_series', 'status')
