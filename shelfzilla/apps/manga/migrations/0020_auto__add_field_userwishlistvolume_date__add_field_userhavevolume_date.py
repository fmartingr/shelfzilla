...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserWishlistVolume.date'
        db.add_column(u'manga_userwishlistvolume', 'date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 6, 20, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'UserHaveVolume.date'
        db.add_column(u'manga_userhavevolume', 'date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 6, 20, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserWishlistVolume.date'
        db.delete_column(u'manga_userwishlistvolume', 'date')

        # Deleting field 'UserHaveVolume.date'
        db.delete_column(u'manga_userhavevolume', 'date')
