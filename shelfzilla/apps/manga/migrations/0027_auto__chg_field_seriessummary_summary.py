...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SeriesSummary.summary'
        db.alter_column(u'manga_seriessummary', 'summary', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'SeriesSummary.summary'
        raise RuntimeError("Cannot reverse this migration. 'SeriesSummary.summary' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'SeriesSummary.summary'
        db.alter_column(u'manga_seriessummary', 'summary', self.gf('django.db.models.fields.TextField')())
