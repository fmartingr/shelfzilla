...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UserHaveVolume'
        db.create_table(u'manga_userhavevolume', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('volume', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['manga.Volume'])),
        ))
        db.send_create_signal(u'manga', ['UserHaveVolume'])


    def backwards(self, orm):
        # Deleting model 'UserHaveVolume'
        db.delete_table(u'manga_userhavevolume')
    ...
    models = {
        ...
        u'manga.userhavevolume': {
            ...
            'volume': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['manga.Volume']"})
        },
        u'manga.volume': {
