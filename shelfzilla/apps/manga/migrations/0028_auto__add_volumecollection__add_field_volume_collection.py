...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'VolumeCollection'
        db.create_table(u'manga_volumecollection', (
            ...
            ('series', self.gf('django.db.models.fields.related.ForeignKey')(related_name='collections', to=orm['manga.Series'])),
            ('default', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal(u'manga', ['VolumeCollection'])

        # Adding field 'Volume.collection'
        db.add_column(u'manga_volume', 'collection',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['manga.VolumeCollection'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'VolumeCollection'
        db.delete_table(u'manga_volumecollection')

        # Deleting field 'Volume.collection'
        db.delete_column(u'manga_volume', 'collection_id')
    ...
    models = {
        ...
        u'manga.volume': {
            ...
            'collection': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['manga.VolumeCollection']", 'null': 'True'}),
            'cover': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['filer.Image']", 'null': 'True', 'blank': 'True'}),
            'for_review': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'for_review_comment': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'hidden': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
