...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'manga_series', 'name', self.gf('django.db.models.fields.CharField')(max_length=256))

    def backwards(self, orm):

        # Changing field 'Series.name'
        db.alter_column(u'manga_series', 'name', self.gf('django.db.models.fields.CharField')(max_length=40))
