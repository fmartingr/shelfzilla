...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UserWishlistVolume'
        db.create_table(u'manga_userwishlistvolume', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='want_volumes', to=orm['auth.User'])),
            ('volume', self.gf('django.db.models.fields.related.ForeignKey')(related_name='wishlisted_by', to=orm['manga.Volume'])),
        ))
        db.send_create_signal(u'manga', ['UserWishlistVolume'])


    def backwards(self, orm):
        # Deleting model 'UserWishlistVolume'
        db.delete_table(u'manga_userwishlistvolume')
    ...
    models = {
        ...
        u'manga.userwishlistvolume': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'want_volumes'", 'to': u"orm['auth.User']"}),
