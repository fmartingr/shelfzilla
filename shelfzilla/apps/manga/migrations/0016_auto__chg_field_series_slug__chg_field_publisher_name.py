...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Series.slug'
        db.alter_column(u'manga_series', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=256, null=True))

        # Changing field 'Publisher.name'
        db.alter_column(u'manga_publisher', 'name', self.gf('django.db.models.fields.CharField')(max_length=50))

    def backwards(self, orm):

        # Changing field 'Series.slug'
        db.alter_column(u'manga_series', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50, null=True))

        # Changing field 'Publisher.name'
        db.alter_column(u'manga_publisher', 'name', self.gf('django.db.models.fields.CharField')(max_length=40))
