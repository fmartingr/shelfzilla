...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SeriesSummary'
        db.create_table(u'manga_seriessummary', (
            ...
            ('series', self.gf('django.db.models.fields.related.ForeignKey')(related_name='summaries', to=orm['manga.Series'])),
            ('language', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['manga.Language'])),
            ('summary', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'manga', ['SeriesSummary'])

        # Adding model 'SeriesPublisher'
        db.create_table(u'manga_seriespublisher', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('for_review', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('for_review_comment', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('hidden', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('series', self.gf('django.db.models.fields.related.ForeignKey')(related_name='publishers', to=orm['manga.Series'])),
            ('publisher', self.gf('django.db.models.fields.related.ForeignKey')(related_name='series_published', to=orm['manga.Publisher'])),
            ('status', self.gf('django.db.models.fields.CharField')(default='open', max_length=16)),
            ('actual_publisher', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal(u'manga', ['SeriesPublisher'])


    def backwards(self, orm):
        # Deleting model 'SeriesSummary'
        db.delete_table(u'manga_seriessummary')

        # Deleting model 'SeriesPublisher'
        db.delete_table(u'manga_seriespublisher')
    ...
    models = {
        ...
        u'manga.seriessummary': {
            'Meta': {'object_name': 'SeriesSummary'},
            'for_review': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'for_review_comment': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'hidden': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
