...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Series.art'
        db.delete_column(u'manga_series', 'art_id')

        # Deleting field 'Series.story'
        db.delete_column(u'manga_series', 'story_id')

        # Adding M2M table for field art on 'Series'
        m2m_table_name = db.shorten_name(u'manga_series_art')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('series', models.ForeignKey(orm[u'manga.series'], null=False)),
            ('person', models.ForeignKey(orm[u'manga.person'], null=False))
        ))
        db.create_unique(m2m_table_name, ['series_id', 'person_id'])

        # Adding M2M table for field story on 'Series'
        m2m_table_name = db.shorten_name(u'manga_series_story')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('series', models.ForeignKey(orm[u'manga.series'], null=False)),
            ('person', models.ForeignKey(orm[u'manga.person'], null=False))
    ...
    def backwards(self, orm):
        # Adding field 'Series.art'
        db.add_column(u'manga_series', 'art',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='artist_of', null=True, to=orm['manga.Person']),
                      keep_default=False)

        # Adding field 'Series.story'
        db.add_column(u'manga_series', 'story',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='scriptwriter_of', null=True, to=orm['manga.Person']),
                      keep_default=False)

        # Removing M2M table for field art on 'Series'
        db.delete_table(db.shorten_name(u'manga_series_art'))

        # Removing M2M table for field story on 'Series'
        db.delete_table(db.shorten_name(u'manga_series_story'))
