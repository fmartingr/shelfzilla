...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Volume.language'
        db.add_column(u'manga_volume', 'language',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['manga.Language'], null=True),
                      keep_default=False)

        # Deleting field 'Series.language'
        db.delete_column(u'manga_series', 'language_id')


    def backwards(self, orm):
        # Deleting field 'Volume.language'
        db.delete_column(u'manga_volume', 'language_id')

        # Adding field 'Series.language'
        db.add_column(u'manga_series', 'language',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['manga.Language'], null=True),
                      keep_default=False)
